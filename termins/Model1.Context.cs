...
namespace termins
{
    ...
    public partial class termsEntities1 : DbContext
    {


        public static termsEntities1 _context;


        public termsEntities1()
            : base("name=termsEntities1")
        {
        }
        public static termsEntities1 GetContext()
        {
            if (_context == null)
                _context = new termsEntities1();
            return _context;
        }
